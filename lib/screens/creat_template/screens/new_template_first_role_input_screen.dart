...
class NewTemplateFirstRoleInputScreen extends StatefulWidget {
  const NewTemplateFirstRoleInputScreen({
    super.key,
  });

  @override
  State<NewTemplateFirstRoleInputScreen> createState() =>
      _NewTemplateFirstRoleInputScreenState();
}

class _NewTemplateFirstRoleInputScreenState
    extends State<NewTemplateFirstRoleInputScreen> {
  ...
  void _routeToNextScreen() {
    Navigator.push(
        context,
        MaterialPageRoute(
          builder: (context) => const NewTemplateSecondRoleInputScreen(),
        ));
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Column(
        children: [
          const CreateTemplateProgressIndicator(.4),
          Expanded(
